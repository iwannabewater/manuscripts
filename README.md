...
| 电商图搜多模态表征 Paper List 2026 | 电商图搜多模态表征精读清单：工业部署、文本引导抗噪、Reasoner->Embedder、CIR 与 latent 低延迟；并标明各文与先推理后表征的关系 | `ecommerce-reasoning-then-embed-papers-2026/index.html` / `ecommerce-reasoning-then-embed-papers-2026/ecommerce-reasoning-then-embed-papers-2026.pdf` |
