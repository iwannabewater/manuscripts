...
| 电商图搜先推理后表征 Paper List 2026 | 先推理后表征主线的 15 篇精读清单：MOON3.0、TIGER-FG、Pailitao-VL、通用 RTE、CIR 与 latent 低延迟 | `ecommerce-reasoning-then-embed-papers-2026/index.html` / `ecommerce-reasoning-then-embed-papers-2026/ecommerce-reasoning-then-embed-papers-2026.pdf` |
