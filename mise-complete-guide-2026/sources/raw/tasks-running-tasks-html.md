...
> Source: https://mise.jdx.dev/tasks/running-tasks.html
...
bashmise run build arg1 arg2 ::: test arg3 arg4
...
toml[tasks."lint:eslint"] # using a ":" means we need to add quotes
run = "eslint ."
[tasks."lint:prettier"]
run = "prettier --check ."
[tasks.lint]
