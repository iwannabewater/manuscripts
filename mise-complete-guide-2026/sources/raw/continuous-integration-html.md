...
> Source: https://mise.jdx.dev/continuous-integration.html
...
shellmise generate bootstrap -l -w
...
You can use any docker image with mise installed to run your CI jobs. Here's an example using debian-slim as base image:
Example Dockerfile
dockerfileFROM debian:12-slim
